...
export enum AuditAction {
  ...
  INVOICE_EMAIL_ACCEPTED = "INVOICE_EMAIL_ACCEPTED",
  INVOICE_EMAIL_DELIVERED = "INVOICE_EMAIL_DELIVERED",
  INVOICE_EMAIL_DELAYED = "INVOICE_EMAIL_DELAYED",
  INVOICE_EMAIL_FAILED = "INVOICE_EMAIL_FAILED",
  INVOICE_EMAIL_BOUNCED = "INVOICE_EMAIL_BOUNCED",
  INVOICE_EMAIL_COMPLAINED = "INVOICE_EMAIL_COMPLAINED",
  INVOICE_EMAIL_SUPPRESSED = "INVOICE_EMAIL_SUPPRESSED",
}
