...
const createEmptyItem = () => ({ name: "", qty: "1", price: "0" });
...
export default function NewInvoicePage() {
  ...
  const [errors, setErrors] = useState<FormErrors>(emptyErrors(initialState.items.length));
  ...
  return (
    <main className="mx-auto max-w-4xl space-y-8 p-6">
      <header className="space-y-2">
        <h1 className="text-3xl font-semibold">Buat Invoice Manual</h1>
        <p className="text-sm text-muted-foreground">
          Lengkapi detail klien dan item layanan sebelum mengirim invoice.
        </p>
      </header>
