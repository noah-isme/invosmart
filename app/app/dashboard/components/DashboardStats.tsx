          ...
          <div className="glow-border rounded-[28px]">
            <div className="glow-border-inner overflow-hidden rounded-[26px] p-6">
              <motion.span
                ...
                className="pointer-events-none absolute -right-10 top-0 h-24 w-24 rounded-full bg-[#6366F1]/20 blur-3xl"
              />
              <motion.span
                aria-hidden
                ...
                className="pointer-events-none absolute -bottom-10 left-6 h-24 w-24 rounded-full bg-[#22D3EE]/10 blur-[90px]"
              />
              <div className="relative flex flex-col gap-4">
                <p className="text-xs uppercase tracking-[0.32em] text-white/55">{card.label}</p>
                <p className="text-3xl font-semibold text-white">{card.value}</p>
                <p className="text-sm text-white/65">{card.helper}</p>
              </div>
            </div>
          </div>
        </motion.article>
