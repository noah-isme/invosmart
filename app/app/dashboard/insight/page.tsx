  ...
  return (
    <main className="relative mx-auto w-full max-w-6xl px-4 pb-24 pt-10">
      <div className="mb-10 space-y-4">
        <p className="text-xs uppercase tracking-[0.42em] text-text/50">Analitik pendapatan</p>
        <h1 className="text-4xl font-semibold text-text">Insight pembayaran real-time</h1>
